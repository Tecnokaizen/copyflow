-- Rollback E2B: recreate the 7 legacy (v1) order-edit RPCs.
-- Source: 20260917214500_order_archived_immutability.sql (for 6 functions)
--         20260917180000_order_lifecycle_v1.sql (for change_order_status)
-- Does NOT touch *_v2 functions, archive_order, row_version, trigger,
-- lifecycle, Kiosk, or data.
...
-- ---------------------------------------------------------------------------
-- change_order_status  (source: 20260917180000_order_lifecycle_v1.sql)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Comments & grants (mirrors 20260917214500 + 20260907171432)
-- ---------------------------------------------------------------------------
